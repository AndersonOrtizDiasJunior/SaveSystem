...
const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UParentSaveGame_Statics::NewProp_ObjectsToDestroy_Inner = { "ObjectsToDestroy", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UParentSaveGame_Statics::NewProp_ObjectsToDestroy = { "ObjectsToDestroy", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UParentSaveGame, ObjectsToDestroy), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ObjectsToDestroy_MetaData), NewProp_ObjectsToDestroy_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UParentSaveGame_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UParentSaveGame_Statics::NewProp_ObjectsToDestroy_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UParentSaveGame_Statics::NewProp_ObjectsToDestroy,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_ander_OneDrive_Documentos_Unreal_Projects_MyProject2_Plugins_SaveSystem_Source_CompleteSaveSystem_Public_ParentSaveGame_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UParentSaveGame, UParentSaveGame::StaticClass, TEXT("UParentSaveGame"), &Z_Registration_Info_UClass_UParentSaveGame, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParentSaveGame), 382362507U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ander_OneDrive_Documentos_Unreal_Projects_MyProject2_Plugins_SaveSystem_Source_CompleteSaveSystem_Public_ParentSaveGame_h_2506944186(TEXT("/Script/CompleteSaveSystem"),
	Z_CompiledInDeferFile_FID_Users_ander_OneDrive_Documentos_Unreal_Projects_MyProject2_Plugins_SaveSystem_Source_CompleteSaveSystem_Public_ParentSaveGame_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ander_OneDrive_Documentos_Unreal_Projects_MyProject2_Plugins_SaveSystem_Source_CompleteSaveSystem_Public_ParentSaveGame_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
