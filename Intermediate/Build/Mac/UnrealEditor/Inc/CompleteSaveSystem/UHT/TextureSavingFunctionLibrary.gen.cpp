...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UTextureSavingFunctionLibrary_CreateTextureFromSaveData_Statics::NewProp_TextureData = { "TextureData", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TextureSavingFunctionLibrary_eventCreateTextureFromSaveData_Parms, TextureData), Z_Construct_UScriptStruct_FSaveTextureData, METADATA_PARAMS(0, nullptr) }; // 1070763200
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UTextureSavingFunctionLibrary_GetTextureSaveData_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TextureSavingFunctionLibrary_eventGetTextureSaveData_Parms, ReturnValue), Z_Construct_UScriptStruct_FSaveTextureData, METADATA_PARAMS(0, nullptr) }; // 1070763200
...
struct Z_Construct_UClass_UTextureSavingFunctionLibrary_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTextureSavingFunctionLibrary_CreateTextureFromSaveData, "CreateTextureFromSaveData" }, // 95856245
		{ &Z_Construct_UFunction_UTextureSavingFunctionLibrary_GetTextureSaveData, "GetTextureSaveData" }, // 1816638633
...
struct Z_CompiledInDeferFile_FID_andersondj_Anderson_BYUI_TCC_savesystemplugin_SaveSystem_Plugins_CompleteSaveSystem_Source_CompleteSaveSystem_Public_TextureSavingFunctionLibrary_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTextureSavingFunctionLibrary, UTextureSavingFunctionLibrary::StaticClass, TEXT("UTextureSavingFunctionLibrary"), &Z_Registration_Info_UClass_UTextureSavingFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTextureSavingFunctionLibrary), 3092964235U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_andersondj_Anderson_BYUI_TCC_savesystemplugin_SaveSystem_Plugins_CompleteSaveSystem_Source_CompleteSaveSystem_Public_TextureSavingFunctionLibrary_h_3934048129(TEXT("/Script/CompleteSaveSystem"),
